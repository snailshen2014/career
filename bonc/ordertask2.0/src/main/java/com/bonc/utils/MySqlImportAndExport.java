...
public class MySqlImportAndExport {
	...
	public static void main(String args[]) throws IOException {
		InputStream is = MySqlImportAndExport.class.getClassLoader().getResourceAsStream("application-dev.properties");
	...
	private static String[] getImportCommand(Properties properties) {
		...
		String importDatabaseName = properties
				.getProperty("jdbc.importDatabaseName");// 导入的目标数据库的名称
