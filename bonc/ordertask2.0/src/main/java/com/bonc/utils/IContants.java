...
public class IContants {
	...
	public static final String SFTP_ERROR_CODE="000002";
	...
	public static final String TC_CHANNEL_3 = "83";//弹窗社会渠道
	...
	public static final String Tel_CHANNEL = "12";//电话渠道
	public static final String Other_CHANNEL = "15";//其他渠道
	public static final String ZongBuSms_CHANNEL = "3";//总部渠道
	public static final String Weixi_CHANNEL = "16";//维系渠道
	public static final String StyleBox_CHANNEL = "17";//九宫格渠道
	public static final String MinAccept_CHANNEL = "18";//极简渠道
	public static final String OutCall_CHANNEL = "21";//海南外呼渠道
	public static final String Waihu_CHANNEL = "22";//广西外呼渠道
	public static final String KeFu_CHANNEL = "23";//广西客服渠道
	public static final String Broadband_CHANNEL= "24";//黑龙江宽带渠道


	public static final String DO_SPLIT = ".";//.分隔符
	public static final Object CO_SPLIT = ",";//,分隔符
	public static final Object SPACE = " ";//空格分隔
	public static final Object SQ_SPLIT = "'";//单引号分隔
	...
	public static final String ORDER_QUERY_ITEMS_CODE_KD = "ORDER_QUERY_ITEMS_CODE_KD";
	public static final String ORDER_QUERY_ITEMS_CODE_MB = "ORDER_QUERY_ITEMS_CODE_MB";
