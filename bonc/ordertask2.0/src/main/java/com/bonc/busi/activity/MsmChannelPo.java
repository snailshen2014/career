 ...
 * @author ICE
 */
public class MsmChannelPo implements ChannelPo {
    /**
     * 渠道Id
     */
     ...
     * 短信免打扰编码
     */
    private String messNodisturbCode;
    /**
     * 短信订购编码
     */
    private String messOrderCode;
    /**
     * 短信有效时间
     */
    private String messEffectiveTime;
    /**
     * 订购失败回复语
     */
    private String orderFailureReply;

    /**
     * 订购超时回复语
     */
    private String orderOvertimeReply;
    ...
    public String getMessNodisturbCode() {
        return messNodisturbCode;
    }

    public void setMessNodisturbCode(String messNodisturbCode) {
        this.messNodisturbCode = messNodisturbCode;
    }

    public String getMessOrderCode() {
        return messOrderCode;
    }

    public void setMessOrderCode(String messOrderCode) {
        this.messOrderCode = messOrderCode;
    }

    public String getMessEffectiveTime() {
        return messEffectiveTime;
    }

    public void setMessEffectiveTime(String messEffectiveTime) {
        this.messEffectiveTime = messEffectiveTime;
    }

    public String getOrderFailureReply() {
        return orderFailureReply;
    }

    public void setOrderFailureReply(String orderFailureReply) {
        this.orderFailureReply = orderFailureReply;
    }

    public String getOrderOvertimeReply() {
        return orderOvertimeReply;
    }

    public void setOrderOvertimeReply(String orderOvertimeReply) {
        this.orderOvertimeReply = orderOvertimeReply;
    }
}
