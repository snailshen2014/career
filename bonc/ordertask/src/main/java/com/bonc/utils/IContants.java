...
public class IContants {
	...
	public static final String Tel_CHANNEL = "14";//电话渠道
	public static final String SMALL_WSC_CHANNEL = "13";//小沃渠道
	public static final String PLAY_CHANNEL = "19";//玩转app
	public static final String NEWWSC_CHANNEL = "20";//本地沃视窗
