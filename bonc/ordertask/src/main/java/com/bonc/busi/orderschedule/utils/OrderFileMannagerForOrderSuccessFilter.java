...
/**
 * 由于OrderFileMannager不是线程安全的类，工单成功过滤或成功检查时用FTP下载文件时可能会导致覆盖工单
 * 生成过程中的iOrignalNum值
 */
public class OrderFileMannagerForOrderSuccessFilter {
	...
	private static final Logger logger = Logger.getLogger(OrderFileMannagerForOrderSuccessFilter.class);
	/*
