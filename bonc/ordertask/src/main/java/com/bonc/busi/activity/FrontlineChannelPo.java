...
public class FrontlineChannelPo {
	...
	/**
	 * 是否对客户经理进行短信提醒字段1：是；0：否
	 */
	private String isRemindManager;
	

	public String getIsRemindManager() {
		return isRemindManager;
	}

	public void setIsRemindManager(String isRemindManager) {
		this.isRemindManager = isRemindManager;
	}
