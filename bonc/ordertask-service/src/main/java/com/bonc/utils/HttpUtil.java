...
//		String testUrl = "http://localhost:17001/ordertask-service/activity/getOrderChannelListByActivityIdAndSeqId/41126/990011/uni076";
//		String result = HttpUtil.doGet(testUrl, null);
//		System.out.println(result);
		
		String testUrl2 = "http://10.245.2.222:8088/ordertask-service/activity/ordergenstatus";
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("tenantId", "uni081");
		map.put("activityId", "41600");
		String rs = HttpUtil.sendPost(testUrl2, JSON.toJSONString(map));
