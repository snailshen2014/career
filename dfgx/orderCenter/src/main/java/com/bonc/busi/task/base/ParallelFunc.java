...
public class ParallelFunc {
	...
	// --- 取数线程状态 ---
	private	char		cGetThreadState = '0';		
	// --- 处理线程当前数量  ---
	private	int		iCurHandleThreadNum = 0;
	private	boolean	bNoDataQuitFlag = true;		// --- 无数据退出标识 ---
	private	int		iMaxQueueSize = 20;
	
	BlockingQueue<Object> buffer = new LinkedBlockingQueue<Object>();
