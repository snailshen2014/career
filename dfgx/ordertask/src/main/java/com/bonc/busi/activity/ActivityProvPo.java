...
public class ActivityProvPo extends StockMarketingPo {
	 ...
	 * 本地沃视窗
	 */
	private ChannelLocalWoWindowPo channelLocalWoWindowPo;
	/**
	/**
	 * 
	 */
	private ChannelPlayFlow channelPlayFlow;
	private MsmChannelPo msmChannelPo;
	...
	//小沃渠道
	private ChannelSmallWoPo  channelSmallWoPo;
	/**
	 * 自定义特殊筛选
	 */
	...
	public void setChannelWebchatInfo(ChannelWebchatInfo channelWebchatInfo) {
	   ...
	   private String channelCheck;
		...
		public ChannelSmallWoPo getChannelSmallWoPo() {
			return channelSmallWoPo;
		}

		public void setChannelSmallWoPo(ChannelSmallWoPo channelSmallWoPo) {
			this.channelSmallWoPo = channelSmallWoPo;
		}

		public ChannelPlayFlow getChannelPlayFlow() {
			return channelPlayFlow;
		}

		public void setChannelPlayFlow(ChannelPlayFlow channelPlayFlow) {
			this.channelPlayFlow = channelPlayFlow;
		}
		
		public void setChannelLocalWoWindowPo(ChannelLocalWoWindowPo channelLocalWoWindowPo) {
			this.channelLocalWoWindowPo = channelLocalWoWindowPo;
		}
		public ChannelLocalWoWindowPo getChannelLocalWoWindowPo() {
			return channelLocalWoWindowPo;
		}
}
