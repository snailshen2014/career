...
public interface FilterOrderService {
	// 删除重复工单
	void updateRepetitiveOrder(Integer activitySEQId, String tenantId, boolean isSMS);
	...
	void filterOrderStatus(Integer activitySEQID, String tenantId, boolean isSMS);

	/**
	 * 根据接触频次过滤工单
	 */
	void updateOrderByTouchLimitDay(Integer activitySEQId, String tenantId, boolean isSMS);
	 ...
	 * @param isFilterSMS
	 */
	void filterBlackUser(String tenant_id, Integer activity_seq_id, boolean isFilterSMS);
	 ...
	 * @param isFilterSMS
	 */
	void filterWhiteUser(String tenant_id, Integer activity_seq_id, boolean isFilterSMS);
