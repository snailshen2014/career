...
public class IContants {
	...
	public static final String xwc_CHANNEL = "13";//小沃侧
	public static final String newWsc_CHANNEL = "20";//小沃侧
	...
	//获取用户信息字段
	public static final String PHONE_FOR_ORDER_INFO = "PHONE_FOR_ORDER_INFO";
