...
public class ActivityProvPo extends StockMarketingPo {
     ...
     * 其他渠道信息
     */
    private ChannelOtherPo channelOtherPo;

    /**
     *  总部短信渠道信息
     */
    private ZongBuMsmChannelPo zongBuMsmChannelPo;

    //电话渠道
    private TelePhoneChannelPo channelTelePhone;

    //海南外呼渠道
    private ChannelOutcallPo channelOutcallPo;

    /**
     * 黑龙江三个渠道
     */
    private WxwlChannelList wxwlChannelList;
    private StyleBoxChannelList styleBoxChannelList;
    private MinAcceptChannelList minAcceptChannelList;
    private BroadbandCallList broadbandCallList;
    /**
     * 自定义特殊筛选
     */
     ...
     * 按月活动指定日期
     */
    private Integer orderAppointDate;
    ...
    public ChannelOtherPo getChannelOtherPo() {
        return channelOtherPo;
    }

    public void setChannelOtherPo(ChannelOtherPo channelOtherPo) {
        this.channelOtherPo = channelOtherPo;
    }

    public ZongBuMsmChannelPo getZongBuMsmChannelPo() {
        return zongBuMsmChannelPo;
    }

    public void setZongBuMsmChannelPo(ZongBuMsmChannelPo zongBuMsmChannelPo) {
        this.zongBuMsmChannelPo = zongBuMsmChannelPo;
    }
    ...
    // 电信通用渠道 list中包含不同下发规则 po用客户经理
    private List<FrontlineChannelPo> DChannel;

    public List<FrontlineChannelPo> getDChannel() {
        return DChannel;
    }

    public void setDChannel(List<FrontlineChannelPo> DChannel) {
    ...
    public TelePhoneChannelPo getChannelTelePhone() {
        return channelTelePhone;
    }

    public void setChannelTelePhone(TelePhoneChannelPo channelTelePhone) {
        this.channelTelePhone = channelTelePhone;
    }

    public WxwlChannelList getWxwlChannelList() {
        return wxwlChannelList;
    }

    public void setWxwlChannelList(WxwlChannelList wxwlChannelList) {
        this.wxwlChannelList = wxwlChannelList;
    }

    public StyleBoxChannelList getStyleBoxChannelList() {
        return styleBoxChannelList;
    }

    public void setStyleBoxChannelList(StyleBoxChannelList styleBoxChannelList) {
        this.styleBoxChannelList = styleBoxChannelList;
    }

    public MinAcceptChannelList getMinAcceptChannelList() {
        return minAcceptChannelList;
    }

    public void setMinAcceptChannelList(MinAcceptChannelList minAcceptChannelList) {
        this.minAcceptChannelList = minAcceptChannelList;
    }
    
    //电信项目-奖励描述
  	private String reward_desc;  
  	//电信项目-渠道协同
  	private String channelSynergism;
	...
	public String getChannelSynergism() {
		return channelSynergism;
	}

	public void setChannelSynergism(String channelSynergism) {
		this.channelSynergism = channelSynergism;
	}


    public ChannelOutcallPo getChannelOutcallPo() {
        return channelOutcallPo;
    }

    public void setChannelOutcallPo(ChannelOutcallPo channelOutcallPo) {
        this.channelOutcallPo = channelOutcallPo;
    }

    private KefuChannelList kefuChannelList;
	private WaihuChannelList waihuChannelList;

    public KefuChannelList getKefuChannelList() {
        return kefuChannelList;
    }

    public void setKefuChannelList(KefuChannelList kefuChannelList) {
        this.kefuChannelList = kefuChannelList;
    }

    public WaihuChannelList getWaihuChannelList() {
        return waihuChannelList;
    }

    public void setWaihuChannelList(WaihuChannelList waihuChannelList) {
        this.waihuChannelList = waihuChannelList;
    }

    public Integer getOrderAppointDate() {
        return orderAppointDate;
    }

    public void setOrderAppointDate(Integer orderAppointDate) {
        this.orderAppointDate = orderAppointDate;
    }

    public BroadbandCallList getBroadbandCallList() {
        return broadbandCallList;
    }

    public void setBroadbandCallList(BroadbandCallList broadbandCallList) {
        this.broadbandCallList = broadbandCallList;
    }
}
