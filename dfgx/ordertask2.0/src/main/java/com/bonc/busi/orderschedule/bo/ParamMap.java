...
public class ParamMap {
	...
	//every time get order numbers
	private String LIMIT_NUMBER;
	public String getLIMIT_NUMBER() {
		return LIMIT_NUMBER;
	}
	public void setLIMIT_NUMBER(String lim) {
		LIMIT_NUMBER = lim;
	}
	private String BEGIN_REC_ID;
	public String getBEGIN_REC_ID() {
		return BEGIN_REC_ID;
	}
	public void setBEGIN_REC_ID(String id) {
		BEGIN_REC_ID = id;
	}
	private String USER_ID_SQL;
	public String getUSER_ID_SQL() {
		return USER_ID_SQL;
	}
	public void setUSER_ID_SQL(String sql) {
		USER_ID_SQL = sql;
	}
	private String TOUCH_LIMIT_DAY;
	public String getTOUCH_LIMIT_DAY() {
		return TOUCH_LIMIT_DAY;
	}
	public void setTOUCH_LIMIT_DAY(String day) {
		TOUCH_LIMIT_DAY = day;
	}
	...
	/************工单中心2.0改造请求工单表路由模块获取工单表名需要的工单过滤数*************************/
	//过滤的工单数 
	int FILTER_COUNT;
